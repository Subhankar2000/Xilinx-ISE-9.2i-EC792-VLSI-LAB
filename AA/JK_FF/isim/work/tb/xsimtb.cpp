...
{
    extern HSim__s6* createWork_jkff_behavioral(const char*);
    HSim__s6 *blk = createWork_jkff_behavioral(label);
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("jkff/behavioral", (HSimInstFactoryPtr)IF2, true);
        (*cfgvh).addVlogModule("jkff", (HSimInstFactoryPtr)IF3, true);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMtb(const char*);
